...
var tracks = []*Track{
	...
	{"Super", "Moby", "Moby", 1990, length("1m38s")},
	{"Head", "Alicia", "Shut it up", 2011, length("5m38s")},
	{"Bed", "Alicia", "night", 2010, length("5m38s")},
	{"Alphabet", "Alicia", "abcd", 2015, length("5m38s")},
	{"Tumiki", "01", "Sit", 451, length("10m38s")},
}
